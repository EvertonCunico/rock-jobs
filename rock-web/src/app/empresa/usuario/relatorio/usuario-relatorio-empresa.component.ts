...
@Component({
  selector: 'app-usuario-relatorio-empresa',
  templateUrl: './usuario-relatorio-empresa.component.html',
})
export class RelatorioUsuarioEmpresaComponent implements OnInit {
  ...
  cancelar() {
    this.router.navigate(['/empresa/usuario/pesquisa']);
  }
