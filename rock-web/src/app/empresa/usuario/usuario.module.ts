...
import { RelatorioUsuarioEmpresaComponent } from './relatorio/usuario-relatorio-empresa.component';

@NgModule({
  // Declaração dos componentes de Pesquisa e Manutenção
  declarations: [UsuarioPesquisaComponent, UsuarioManutencaoComponent, RelatorioUsuarioEmpresaComponent],
    imports: [
        ProgramaCrudModule.config({
            ...
            relatorio: RelatorioUsuarioEmpresaComponent
        }),
